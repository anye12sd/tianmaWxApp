// component/serviceBtn/serviceBtn.js
Component({
  /**
   * 组件的属性列表
   */
  ...
  methods: {
    changePlay(){
      ...
      line1OpenAn.translateY(11).rotate(45).scale(0.8, 1).opacity(1).step();
      this.setData({
      ...
      line1CloseAn.translateY(0).rotate(0).scale(1, 1).opacity(0).step();
      this.setData({
      ...
      line2OpenAn.translateY(-1.5).translateX(-6).rotate(-45).scale(0.8, 1).opacity(1).step();
      this.setData({
      ...
      line2CloseAn.translateY(0).rotate(0).scale(1, 1).opacity(0).step();
      this.setData({
